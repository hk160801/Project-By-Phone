#pragma checksum "C:\Users\Admin\OneDrive - Đại học FPT- FPT University\Desktop\Project\Project\ShopProject_Client\ShopProject_Client\Pages\CartDocker\Cart.cshtml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "4f7d69f7b1d4611032e2af98db7b79ca96fbcb70aa2a56de583945e8e5b74b39"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA256", @"4f7d69f7b1d4611032e2af98db7b79ca96fbcb70aa2a56de583945e8e5b74b39", @"/Pages/CartDocker/Cart.cshtml")]
    ...
    #nullable disable
    {
        ...
        {
#nullable restore
#line 3 "C:\Users\Admin\OneDrive - Đại học FPT- FPT University\Desktop\Project\Project\ShopProject_Client\ShopProject_Client\Pages\CartDocker\Cart.cshtml"
    ...
    $(document).ready(function () {
        ...
        if (accessToken != null) {
            ...
            WriteLiteral(@"                       <polygon points=""10 4.5 5.5 4.5 5.5 0 4.5 0 4.5 4.5 0 4.5 0 5.5 4.5 5.5 4.5 10 5.5 10 5.5 5.5 10 5.5""></polygon>
                                                            ...
                                                            <li>
                                                                   <div class=""close1""><a href=""#"" onclick=""deletecart(this)"" data-id=""${cartItem.cartId}""><span class=""glyphicon glyphicon-trash iconglyphicon"" aria-hidden=""true""");
...
<script>
    ...
    function pluscart(link) {
        ...
        var dataId = link.getAttribute('data-id');
        $.ajax({
            url: 'https://localhost:44312/Carts/Pluss?id=' + dat");
            WriteLiteral(@"aId,
            method: 'GET',
            headers: {
                'Authorization': 'Bearer ' + accessToken
